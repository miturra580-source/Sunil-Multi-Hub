  ...
  function enhance() {
    ...
    if (!document.getElementById('smhCertificateStyles')) {
      ...
      style.textContent=`
        ...
        .smh-cert-docs{margin-top:18px;padding-top:16px;border-top:1px solid #dfe6f0}.smh-cert-docs h3{margin:0 0 10px}.smh-cert-doc-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.smh-cert-doc{padding:10px 12px;border:1px solid #e5eaf2;border-radius:12px;background:#fff;font-size:12px;font-weight:700;color:#475467}.smh-cert-warning{margin-top:12px;padding:12px 14px;border:1px solid #f0b429;border-radius:12px;background:#fff8e6;color:#7a5612;font-size:12px;font-weight:800;line-height:1.5}
    ...
    if (!box.querySelector('.smh-cert-docs')) {
      ...
      docs.innerHTML=`<h3>📄 आवश्यक दस्तावेज़</h3><div class="smh-cert-doc-grid"><div class="smh-cert-doc">✓ फोटो — अनिवार्य</div><div class="smh-cert-doc">✓ आधार कार्ड — अनिवार्य</div><div class="smh-cert-doc">✓ परिवार रजिस्टर — अनिवार्य</div><div class="smh-cert-doc">✓ 18 वर्ष से कम आयु पर पिता का आधार — अनिवार्य</div><div class="smh-cert-doc">अन्य दस्तावेज़ 1 — वैकल्पिक</div><div class="smh-cert-doc">अन्य दस्तावेज़ 2 — वैकल्पिक</div></div><div class="smh-cert-warning">⚠️ केवल Original Document की clear scan/photo या साफ photocopy ही upload करें। धुंधली, कटी हुई या unreadable copy स्वीकार न करें।</div><p style="font-size:11px;color:#667085;line-height:1.45;margin:10px 0 0">eDistrict पर Aadhaar OTP की जरूरत होने पर OTP वहीं manual दर्ज किया जाएगा।</p>`;
