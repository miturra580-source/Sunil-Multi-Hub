...
(function loadSmhModules() {
  ...
  const modules = [
    ...
    ['ration-card-hotfix.js?v=20260823-2','data-smh-ration-card-hotfix',['dashboard.html']],
    ['ration-card-persistence.js?v=20260823-1','data-smh-ration-card-persistence',['dashboard.html']],
    ...
    ['certificate-document-rules.js?v=20260823-2','data-smh-certificate-document-rules',['dashboard.html']],
  ...
  modules.forEach(([src,attr,pages])=>{
    ...
    const s=document.createElement('script');s.src=src;s.defer=true;s.setAttribute(attr,'true');document.head.appendChild(s);
  });
})();